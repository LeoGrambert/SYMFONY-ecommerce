...
use LG\CoreBundle\Provider\BookingProvider;
...
class Stripe
{
    public function checkout(BookingProvider $bookingProvider, Booking $booking)
    {
        $price = ($bookingProvider->getPrice($booking))*100;
